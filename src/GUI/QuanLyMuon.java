...
public class QuanLyMuon extends JPanel {
	...
	public QuanLyMuon() {
		...
		gl_pnView.setHorizontalGroup(gl_pnView.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnView.createSequentialGroup().addGroup(gl_pnView.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_pnView.createSequentialGroup().addGap(56)
								.addComponent(lbFind, GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE).addGap(40)
								.addComponent(txtFind, GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE).addGap(120))
						.addGroup(
								gl_pnView.createSequentialGroup().addGap(88)
										.addGroup(gl_pnView.createParallelGroup(Alignment.LEADING)
												...
												.addComponent(lbNgayMuon, GroupLayout.DEFAULT_SIZE,
														GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
										.addPreferredGap(ComponentPlacement.UNRELATED)
										.addGroup(gl_pnView.createParallelGroup(Alignment.LEADING)
												.addComponent(txtMaThe, GroupLayout.DEFAULT_SIZE, 132, Short.MAX_VALUE)
												.addComponent(txtNgayMuon, GroupLayout.DEFAULT_SIZE, 132,
														Short.MAX_VALUE))
										.addPreferredGap(ComponentPlacement.UNRELATED)
										.addGroup(gl_pnView.createParallelGroup(Alignment.LEADING)
												.addComponent(lbMaSach, GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
												.addComponent(lbMaThuThu, GroupLayout.DEFAULT_SIZE, 128,
														Short.MAX_VALUE))
										.addPreferredGap(ComponentPlacement.UNRELATED)
										.addGroup(gl_pnView.createParallelGroup(Alignment.LEADING)
												.addComponent(txtMaSach, GroupLayout.DEFAULT_SIZE, 139, Short.MAX_VALUE)
												.addComponent(txtMaThuThu, GroupLayout.DEFAULT_SIZE, 139,
														Short.MAX_VALUE)))
						.addGroup(gl_pnView.createSequentialGroup().addGap(140)
								.addComponent(btAdd, GroupLayout.DEFAULT_SIZE, 59, Short.MAX_VALUE).addGap(107)
								.addComponent(btInsert, GroupLayout.PREFERRED_SIZE, 49, Short.MAX_VALUE).addGap(79)
								.addComponent(btDelete, GroupLayout.DEFAULT_SIZE, 98, Short.MAX_VALUE).addGap(100)))
						.addGap(80)));
		gl_pnView.setVerticalGroup(gl_pnView.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnView.createSequentialGroup().addContainerGap()
						.addGroup(gl_pnView.createParallelGroup(Alignment.BASELINE)
								...
								.addComponent(lbFind))
						.addGap(18)
						.addGroup(gl_pnView.createParallelGroup(Alignment.BASELINE).addComponent(lbMaThe)
						...
						.addGap(18)
						.addGroup(gl_pnView.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_pnView.createParallelGroup(Alignment.BASELINE).addComponent(lbNgayMuon)
								...
								.addComponent(txtNgayMuon, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGap(30).addGroup(gl_pnView.createParallelGroup(Alignment.BASELINE).addComponent(btAdd)
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup()
						.addComponent(pnView, javax.swing.GroupLayout.PREFERRED_SIZE,
		...
		QuanLyMuonController controller = new QuanLyMuonController(pnTable, txtFind, txtMaThe, txtMaThuThu, txtMaSach,
				btAdd, btDelete, btInsert, txtNgayMuon);
